...
module BubleBufferFIFO(
  ...
  wire       _BubbleFSMBuffer_7_io_out_empty;
  ...
  wire       _BubbleFSMBuffer_io_in_full;
  ...
  BubbleFSMBuffer BubbleFSMBuffer (
    ...
    .io_in_full     (_BubbleFSMBuffer_io_in_full),
  ...
  BubbleFSMBuffer BubbleFSMBuffer_7 (
    ...
    .io_out_empty   (_BubbleFSMBuffer_7_io_out_empty)
  );
  assign io_in_full =
    _BubbleFSMBuffer_io_in_full | _BubbleFSMBuffer_1_io_in_full
    | _BubbleFSMBuffer_2_io_in_full | _BubbleFSMBuffer_3_io_in_full
    | _BubbleFSMBuffer_4_io_in_full | _BubbleFSMBuffer_5_io_in_full
    | _BubbleFSMBuffer_6_io_in_full | _BubbleFSMBuffer_7_io_in_full;
  assign io_out_empty =
    _BubbleFSMBuffer_io_out_empty & _BubbleFSMBuffer_1_io_out_empty
    & _BubbleFSMBuffer_2_io_out_empty & _BubbleFSMBuffer_3_io_out_empty
    & _BubbleFSMBuffer_4_io_out_empty & _BubbleFSMBuffer_5_io_out_empty
    & _BubbleFSMBuffer_6_io_out_empty & _BubbleFSMBuffer_7_io_out_empty;
endmodule
